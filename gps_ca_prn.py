...
class PRN(am.Elaboratable):
    ...
    Inputs:
        ...
        * io_in[2:7] select PRN1 through PRN32
        * io_in[7] is unused

    Outputs:
        * io_out[0] is the G1 LFSR
        * io_out[1] is the G2 LFSR
        * io_out[2] is the selected PRN
    """
    def __init__(self):
...
if __name__ == "__main__":
    prn = PRN()
    v = verilog.convert(
        prn, name="adamgreig_tt02_gps_ca_prn", ports=[prn.io_out, prn.io_in],
